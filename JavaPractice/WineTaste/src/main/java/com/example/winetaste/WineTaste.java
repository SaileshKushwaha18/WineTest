...
public class WineTaste {
  static { //Native library so the file needs to be at a specified location. "C:\\Users\\Sailesh\\Desktop\\JavaPractice\\WineTaste" is the workspace location . So change accordingly to load the native library file.
	    try {
	    	System.load("C:\\Users\\Sailesh\\Desktop\\JavaPractice\\WineTaste\\src\\main\\resources\\dll\\sqlite4java-win32-x64-1.0.392.dll");
	    } catch (UnsatisfiedLinkError e) {
	      System.err.println("Native code library failed to load.\n" + e);
	      System.exit(1);
	    }
	  } 
	static final String problemFilename = "C:\\Users\\Sailesh\\Desktop\\person_wine_3.txt"; /* Path to problem file C:\\Users\\Sailesh\\Desktop\\ is the input file location*/ 
	static final String resultFilename = "C:\\Users\\Sailesh\\Desktop\\person_wine_result_3.txt"; /* Path to result file C:\\Users\\Sailesh\\Desktop\\ is the output file location*/
